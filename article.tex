...
\end{example_case}
\begin{example_case}
Slika (\ref{im:lattice_with_sublattices}) prikazuje dva primera podmrež na že znanih mrežah. Tako sta na primer množica deliteljev števila $10$, kot tudi množica$\{2,6,10,30\}$ podmreža mreže deliteljev števila $30$ (slika \ref{im:divisors_of_30_with_sublattices}). Prav tako pa je $P(\{1,2,4\})$ podmreža mreže $P(\{1,2,3,4\})$ (slika \ref{im:lattice_1234_with_sublattices}).
\end{example_case}
\end{example}
...
\caption{Mreži s podmrežama}
\label{im:lattice_with_sublattices}
\end{figure}
