...
\end{proof}
Pokažimo sedaj, da lahko iz Booleovega kolobarja pridemo do mreže. V ta namen definirajmo operaciji supremum in infinum in pokažimo, da zadoščata aksimom mreže.
$$ a \lor b = a + b + ab $$
$$ a \land b = ab $$
\begin{enumerate}
