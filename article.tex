...
\end{theorem}
\begin{proof}
Naj bosta $a, b \in L_{1}$. Ker je $a \leq a \land b$ in je tudi $b \leq a \land b$, potem zaradi ohranjanja smeri velja:
$$ f(a) \leq f(a \land b), f(b) \leq f(a \land b) $$
Ker je sta oba $f(a)$ in $f(b)$ manjša od $f(a \land b)$ je tudi njun infinum manjši od  $f(a \land b)$.
$$ f(a) \land f(b) \leq f(a \land b) $$
S tem smo pokazali, da je $f(a \land b)$ spodnja meja elementov $f(a$ in $f(b).$ Pokažimo, da je to še natačna spodnja meja. \\
Denimo, da $f(c) \leq f(a \land b)$. To pomeni, da je 
...
\item \url{https://en.wikipedia.org/wiki/Distributive_lattice}đ
